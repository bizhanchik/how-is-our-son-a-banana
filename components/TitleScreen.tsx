    ...
    <div className="vignette relative flex h-full w-full flex-col items-center justify-center overflow-hidden px-6 text-center">
      ...
      >
        ...
        <motion.button
          ...
          className="mt-10 rounded-full bg-strawberry px-12 py-4 text-lg font-bold text-white shadow-[0_8px_30px_rgba(230,57,80,0.5)] transition-colors hover:bg-crimson sm:text-xl"
        >
          Begin the Drama ▸
        </motion.button>
        <p className="mt-5 max-w-sm text-xs text-cream/40">
